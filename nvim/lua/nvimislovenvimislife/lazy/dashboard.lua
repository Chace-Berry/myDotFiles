return {
	...
	config = function()
		...
		dashboard.section.header.val = get_header(48, false) -- (index, bool) index of ascii art bool if you want random or not eg: (30, false)
		...
		local greeting = function()
			...
			elseif datetime >= 6 and datetime < 12 then
				mesg = " Hi " .. username .. ", Good Morning "
			elseif datetime >= 12 and datetime < 18 then
				mesg = " Hi " .. username .. ", Good Afternoon "
